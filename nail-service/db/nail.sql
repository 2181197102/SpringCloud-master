...
(
    ...
    open_id             VARCHAR(100) COMMENT '微信小程序用户的openid',
...
-- 诊断
INSERT INTO tb_nail_diag (id, open_id, diagnosis_code, doctor_name, patient_name, image_file, diag_result, result_accuracy, feed_back, created_time, updated_time, created_by, updated_by)
VALUES
    ('1', 'openid_123', 'D001', 'user123', 'John Doe', 'https://example.com/image1.jpg', 'Nail infection', 1, 'The diagnosis is accurate.', now(), now(), 'admin', 'admin'),
    ('2', 'openid_456', 'D002', 'user456', 'Jane Smith', 'https://example.com/image2.jpg', 'Nail psoriasis', 1, 'The diagnosis is accurate.', now(), now(), 'admin', 'admin'),
    ('3', 'openid_789', 'D003', 'user789', 'Alice Johnson', 'https://example.com/image3.jpg,https://example.com/image4.jpg', 'Nail trauma', 0, 'The diagnosis needs further examination.', now(), now(), 'admin', 'admin'),
    ('4', 'openid_test2', 'D004', 'test_doctor_2', 'test_patient_2', '/home/zeno/test_image/JGY1.JPG,/home/zeno/test_image/JZJB2.JPG', '', -1, '', now(), now(), 'admin', 'admin'),
    ('5', 'openid_test3', 'D005', '', 'test_patient_2', '/home/zeno/test_image/JGY1.JPG,/home/zeno/test_image/JZJB2.JPG,/home/zeno/test_image/YXBJ16.JPG', '', -1, '', now(), now(), 'admin', 'admin'),
    ('6', 'openid_test4', 'D006', 'tset', 'test', 'test', '', -1, '', now(), now(), 'admin', 'admin'),
    ('7', 'openid_test5', '0ad228ffa5b34798aaae05dcad0185c6', 'tset', 'test', 'test', '', -1, '', now(), now(), 'admin', 'admin');
